    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            TextButton(onPressed: () {}, child: NormalText("publish", 16)),
          ],
        ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            NormalText("Catagory", 16),
            Input(textvalue: "select"),
            SizedBox(height: 10),
            NormalText("What are you selling?", 16),
            Input(),
            SizedBox(height: 10),
            NormalText("Price(\$)", 16),
            Input(textvalue: 0.toString()),
            SizedBox(height: 10),
            NormalText("Location", 16),
            Input(textvalue: "woldia"),
            SizedBox(height: 10),
            NormalText("Description", 16),
            Input(maxline: 5),
            SizedBox(height: 10),
            NormalText("Avaliablity", 16),
            Input(textvalue: "List as Asingle item"),
            SizedBox(height: 10),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                NormalText("Offer shipping", 16),
                SwitchButton(IsOfferDeliverOn: false),
              ],
            ),
            SizedBox(height: 10),
            NormalText("Hide from friends", 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Flexible(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                NormalText("Turn on commenting on list", 16),
